...
/* Exact 40 KiB CST3640 image supplied for the Jujing JN3929595A panel. */
static const uint8_t fw_jujing_cst3640[] =
#include "CST3640_SDK_40K_1.h"
;
...
static const struct hyn_chip_series hyn_6xx_fw[] = {
    {0xCACA2202,0xffffffff,"cst3640",(u8*)fw_jujing_cst3640},
    {0,0,"",NULL}
};
